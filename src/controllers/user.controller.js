  ...
  //aggregation pipeline
    const channel=await User.aggregate([
        ...
        //user ke subscriber count kare
            ...
            // user ne kitne channels ko subscribe kiya hai
             {
                $lookup:{
                    from:"Subscriptions",
                    localField:"_id",
            ...
            // we added few things like subscriberscount,channelsSubscribed,issubscribed inside original fields
            {$addFields: {
                subscribersCount:{
                    $size:"$subscribers"
                },
